...
export const fieldsConfig: Record<NavigationActionKind, FieldConfig[]> = {
  [NavigationActionKind.PAYROLLRECEIPTS]: [
    ...
    { type: 'multi-option', name: 'Percepciones', fetchUrl: 'http://localhost:5239/api/Perception', id: 'perceptions' },
    { type: 'multi-option', name: 'Deducciones', fetchUrl: 'http://localhost:5239/api/Deduction', id: 'deductions' },
  ],
